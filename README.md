...
- [X] [Практическая работа 3](#практическая-работа-3-white_check_mark)
  - [X] [Упражнение 13. Создание и использование каскадных таблиц стилей](#упражнение-13-создание-и-использование-каскадных-таблиц-стилей)
  - [X] [Упражнение 14. Использование классов в создании каскадных таблиц стилей](#упражнение-14-использование-классов-в-создании-каскадных-таблиц-стилей)
  - [X] [Упражнение 15. Использование блочной верстки](#упражнение-15-использование-блочной-верстки)
- [X] [Практическая работа 4](#практическая-работа-4-white_check_mark)
  - [X] [Упражнение 16. Текстовое поле и поле для ввода пароля](#упражнение-16-текстовое-поле-и-поле-для-ввода-пароля)
  - [X] [Упражнение 17. Текстовая область](#упражнение-17-текстовая-область)
  - [X] [Упражнение 18. Работа с флажком](#упражнение-18-работа-с-флажком)
  - [X] [Упражнение 19. Работа с переключателями](#упражнение-19-работа-с-переключателями)
  - [X] [Упражнение 20. Работа со списками](#упражнение-20-работа-со-списками)
...
## Практическая работа 4 :white_check_mark: 
...
```html
    <form>
        ...
        <input type=password name="pas" value="123" size=10 maxlenght=10>
    </form>
```
...
```html
    <from>
        ...
        Прежде чем начать выбирать аналоговую фотокамеру, необходимо определиться, с каким форматом плёнки вы будете работать, так как от этого зависит и выбор камеры. Конечно, можно идти и от обратного, сначала выбрав подходящую камеру. 
        Но лучше заранее знать, на что вы себя обрекаете, так как именно формат кадра определяет и качество снимка, и, что важно, стиль съёмки. Тут стоит отметить момент, о котором в цифровой фотографии никто не задумывается — себестоимость кадра.
        </textarea>
    </from>
```
...
```html
   <from action="URL-адрес сервера" method=post enctype=multipart/from-data>
        <p style="color: #F64C72; font-size:12pt; font-family:Arial">Выберите нужные вам опции:</p>
        1 <input type=checkbox checked name="check1" value=1> тип 135, формат 35 мм
        <br>
        2 <input type=checkbox name="check2" value=2> тип 120, средний формат
    </from>
```
#####  Упражнение 19. Работа с переключателями 

```html
    <form action=”URL-адрес сервера” method=post enctype=multipart/form-data>
        Выберите цвет:<br>
...
```html
    <form action=”URL-адрес сервера” method=post enctype=multipart/form-data>
        <p style="color: #9b4447; font-size:12pt; font-family:Arial"> Владею языком программирования</p>
